        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="mb-8 text-center">
                <motion.h1
                    className="text-2xl sm:text-3xl md:text-4xl font-bold bg-clip-text text-transparent 
                             bg-gradient-to-r from-[#004ea4] via-[#0067d8] to-[#004ea4]
                             dark:from-[#004ea4] dark:via-[#0067d8] dark:to-[#004ea4]"
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 sm:gap-3 auto-rows-[4rem]"
                        initial="hidden"
                        animate="visible"
                        exit="hidden"
                        variants={{
                    ...
                    >
                        {items.map((item, index) => (
                            <motion.div
                                ...
                                style={{
                                    gridRow: `span ${item.span.includes('row-span-3') ? 3 : 3}`
                                }}
