        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6">
          ...
          >
            ...
            <Link 
              ...
              className="group relative inline-flex items-center gap-2 sm:gap-3 bg-white text-brand-blue px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg font-medium hover:bg-brand-beige transition-all duration-300 shadow-lg hover:shadow-xl"
